...
public final class MinecraftServer {
	...
	public String toString() {
		return "MinecraftServer [pingVersion=" + pingVersion
				+ ", protocolVersion=" + protocolVersion + ", gameVersion="
				+ gameVersion + ", motd=" + motd + ", playersOnline="
				+ playersOnline + ", maxPlayers=" + maxPlayers + "]";
	}

	public static void main(String[] args) {
		MinecraftServer query = new MinecraftServer("access.jagare-lilja.se");
		boolean status = query.fetchData();
		if(status)System.out.println(query.toString());
